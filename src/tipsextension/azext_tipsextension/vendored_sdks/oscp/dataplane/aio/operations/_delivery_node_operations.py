...
class DeliveryNodeOperations:
    """DeliveryNodeOperations async operations.
    ...
    async def put(
        self,
        delivery_node_id: str,
        delivery_node: "_models.DeliveryNode",
        **kwargs
    ) -> "_models.DeliveryNode":
    ...
    async def bulk_put(
        self,
        delivery_nodes: List["_models.DeliveryNode"],
        **kwargs
    ) -> List["_models.BulkResponseItemOfDeliveryNode"]:
        """bulk_put.
    ...
    async def get_all_delivery_nodes(
        self,
        **kwargs
    ) -> List["_models.DeliveryNode"]:
