...
class DataOutflowOperations(object):
    """DataOutflowOperations operations.
    ...
    def put_data_outflow(
        self,
        name,  # type: str
        data_outflow,  # type: "_models.DataOutflow"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DataOutflow"
    ...
    def get_all_data_outflows(
        self,
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.DataOutflow"]
    ...
    def post_data_outflow_run(
        self,
        name,  # type: str
        data_outflow_run,  # type: "_models.DataOutflowRun"
        **kwargs  # type: Any
    ):
