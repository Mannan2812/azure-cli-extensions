...
class OrderFulfillmentOperations(object):
    """OrderFulfillmentOperations operations.
    ...
    def accept_new_order_fulfillment(
        self,
        order_fulfillment_id,  # type: str
        order_fulfillment,  # type: "_models.OrderFulfillment"
        **kwargs  # type: Any
    ):
        # type: (...) -> Union["_models.OrderFulfillment", "_models.ErrorObject"]
    ...
    def query_order_fulfillments(
        self,
        created_after=None,  # type: Optional[str]
        created_before=None,  # type: Optional[str]
        status=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.OrderFulfillment"]
